  ...
  return '' +
    '<div class="screen" style="align-items:center; justify-content:center; padding:32px; gap:28px;">' +
      '<div style="display:flex; flex-direction:column; align-items:center; gap:14px;">' +
        ...
        '<div style="font-size:13px;color:var(--color-text-muted);margin-top:2px;">Admin console</div></div>' +
      '</div>' +
      ...
      '<div style="font-size:12px;color:var(--color-text-muted);text-align:center;">Only the two authorized admin Google accounts can access this app</div>' +
    '</div>';
}
