...
import { iconCollection, iconPayout, iconTransfer, iconInfo, iconCalendar, iconLedger, iconWallet, iconChevronLeft } from '../icons.js';
  ...
  return '' +
    '<div class="screen">' +
      '<div class="topbar">' +
        ...
        '<div><div class="title">' + iconLedger('var(--color-primary)') + 'Admin &amp; Ledger</div><div class="subtitle">Balances &amp; transactions across all groups</div></div>' +
      '</div>' +
      '<div class="content">' +
